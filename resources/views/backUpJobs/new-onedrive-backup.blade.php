...
@section('topnav')
    ...
    <div class="col-sm-10 navbarLayout">
        ...
        <ul class="ulNavbar">
            ...
            <li class="liNavbar"><a class="active" href="{{ url('backup',[$arr['typeId'],'add']) }}">New Job</a></li>
                ...
                <div class="col-lg-5">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required class="required form_input form-control" id="jobName" placeholder="Enter Job Name" />
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-lg-5">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select required class="required form_input form-control" name="schedule" id="schedule">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <div style="position: relative">
                                    <input type="text" class="required form_input form-control" required  id="timepicker" />
            ...
            <div class="row" style="margin-bottom: 60px;">
                <div class="col-sm-12 nopadding" style="margin-bottom: 11px;">
                    <h5 class="txt-blue" style="width: fit-content;" data-placement="bottom" style="cursor: pointer;"
                        data-toggle="tooltip" title="This list have users and groups that don’t exist in other Backup Jobs">
                ...
                <div class="col-sm-12 nopadding">
                    <div class="radioDiv flex">
                        <div class="radio m-0">
                            <label class="mr-4">
                                <input type="radio" name="itemsType" class="itemsType" checked value="selectedItems">Selected
                                Items
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="checkbox-container" style="left: 46%;">&nbsp;
                                                        <input type="checkbox" class="form-check-input" id="allOnedrives" />
                                                        <span class="check-mark"></span>
                                                    </label>
                                                </td>
                                            </tr>
