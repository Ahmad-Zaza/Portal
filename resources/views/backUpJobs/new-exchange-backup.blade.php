...
@section('content')
                ...
                <div class="col-lg-5">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form_input form-control required" required id="jobName"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea required id="jobDesc" class="required form_input form-control" name="jobDesc" rows="1"
                                    maxlength="500" placeholder="Enter Job Description"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select required class="form_input form-control required" name="schedule" id="schedule">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select required class="form_input form-control" name="days" id="days">
            ...
            <div class="row" style="margin-bottom: 60px;">
                ...
                <div class="col-sm-12 nopadding">
                    <div class="radioDiv flex">
                        <div class="radio m-0">
                            <label class="mr-4">
                                <input type="radio" name="itemsType" class="itemsType" checked
                        ...
                        <div class="radio" style="margin-top: 0!important;">
                            <label class="mr-4">
                                <input type="radio" name="itemsType" class="itemsType" value="allItems">All Items
                                <span class="checkmark"></span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12" style="margin-top: -40px">
                        <div id="tab1" class="tab-content active">
                            ...
                            <div class="row mr-0 usersPagination">
                                <div class="col-lg-4 flex">
                                    <button type="button" class="pl-0 btn-sm custom-btn-sm hand previousPage" onclick="usersPreviousPage()" title="Previous">
                                        <img class="iconColor mt-0 mr-0 hide-pre hide" src="{{ url('/svg/Pre-02.svg') }}">
                                    ...
                                    <button class="btn-sm custom-btn-sm hand mr-0 nextPage"
                                        onclick="usersNextPage()" title="Next" type="button">
                        ...
                        <div id="tab2" class="tab-content hide">
                            <div class="row">
                                ...
                                <div class="allWidth">
                                    <table id="groupsTable" class="stripe table table-striped table-dark"
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th colspan="3"><span class="groupsShowing">0</span> Groups Showing</th>
                            ...
                            <div class="row mr-0 groupsPagination">
                                <div class="col-lg-4 flex">
                                    <button type="button" class="pl-0 btn-sm custom-btn-sm hand previousPage" onclick="groupsPreviousPage()" title="Previous">
                                        <img class="iconColor mt-0 mr-0 hide-pre hide" src="{{ url('/svg/Pre-02.svg') }}">
                                        <img class="iconColor mt-0 mr-0 show-pre" src="{{ url('/svg/Pre.svg') }}">
                                    </button>
                                    <div class="flex mr-0 align-center">
                                    ...
                                    <button class="btn-sm custom-btn-sm hand mr-0 nextPage"
                                        onclick="groupsNextPage()" title="Next" type="button">
                                        <img class="iconColor mt-0 show-next hide" src="{{ url('/svg/dash-next.svg') }}">
                                        <img class="iconColor mt-0 hide-next" src="{{ url('/svg/Next-01.svg') }}">
                                    </button>
                                </div>
            ...
            <div class="row actions-row" style="margin-bottom: 25px;margin-top:25px;">
                ...
                <div class="col-lg-4 nopadding">
                    <a href="{{ url('backup', $arr['typeId']) }}"
                        ...
                        Cancel Backup Job</a>
                    <button type="submit" onclick="addBackupJob(event)" class="btn_primary_state right-float">
    ...
    <script>
        ...
        function addBackupJob(event) {
            ...
            if (!resultRows.length > 0 && itemsType == "selectedItems") {
            ...
            if (itemsType == "selectedItems") {
                resultRows.each(function() {
                    ...
                    let groupmail = row.find("td:nth(5)").find(".groupmail").length>0?row.find("td:nth(5)").find(".groupmail").prop("checked"):false;
                    let backUpObj = {
                        "id": id,
        ...
        function summarySelectedItems() {
            let usersCount = $("#result-table_wrapper tbody").find("tr[data-type='User']:has(input.form-check-input:checked)").length;
            ...
            let groupsCount = $("#result-table_wrapper tbody").find("tr[data-type!='User']:has(input.form-check-input:checked)").length;
            ...
            let usermailCount = $("#usersTable_wrapper tbody").find("tr[data-type='User']:has(input.form-check-input.usermail:checked)")
                .length;
            ...
            usermailCount = $("#result-table_wrapper tbody").find("tr[data-type!='User']:has(input.form-check-input.usermail:checked)").length;
            userarchivedCount = $("#result-table_wrapper tbody").find("tr[data-type!='User']:has(input.form-check-input.userarchived:checked)")
                .length;
            let usergroupCount = $("#result-table_wrapper tbody").find("tr[data-type!='User']:has(input.form-check-input.groupmail:checked)")
                .length;
            if (groupsCount == 0)
