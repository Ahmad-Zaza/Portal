...
@section('content')
    ...
    <div id="mainContent">
        <form class="backupForm">
                ...
                <div class="col-lg-5">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" required class="required form_input form-control" id="jobName"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="jobDesc" class="required form_input form-control" required name="jobDesc" rows="1" maxlength="500" placeholder="Enter Job Description"></textarea>
                            </div>
                        </div>
            ...
            <div class="row" style="margin-bottom: 60px;">
                <div class="col-sm-12 nopadding">
                    <h5 class="txt-blue" style="width: fit-content;cursor: pointer;" data-placement="bottom"
                ...
                <div id="selectedItemsCont" class="allWidth">
                    <div class="col-sm-12" style="margin-top: -31px">
                        <div id="tab1" class="tab-content active">
                            <div class="row">
                                <div class="allWidth">
                                    <table id="teamsTable" class="stripe table table-striped table-dark "
                                        style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="checkbox-container" style="left: 46%;">&nbsp;
                                                        <input type="checkbox" class="form-check-input" id="allUserTeams" />
                                                        <span class="check-mark"></span>
                                                    </label>
                                                </td>
                                            </tr>
    ...
    <script>
        ...
        function addBackupJob(event) {
            ...
            let allTeams = $('#allUserTeams').prop('checked');
